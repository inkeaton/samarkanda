...
BEGIN
    ...
    /* 
     Siccome il valore peso_fresco_chioma_foglie può essere nullo, lo cerchiamo 
     separatamente
     */
    ...
    THEN
        ...
        IF (prev_peso_fresco_chioma_foglie IS NOT NULL) AND (NEW.peso_fresco_chioma_foglie IS NOT NULL THEN)

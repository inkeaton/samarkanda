...
####################################################
    ...
    environment.systemPackages = with pkgs; [
        ...
        # texlive.combined.scheme-full # Latex full package
        (texlive.combine { inherit (texlive) scheme-medium cancel pifont hyperref multirow float wasysym; }) 
        # To combine latex packages with smaller sets

...
<html lang="it">
    ...
    <body>
        ...
        <?php 
            // Remember me test
            // TO DO: implement redirection and similars
    ...
    <!------------------------------------------------------------------------------------>
            <?php
                function common_input_test($data) {
                    // check if void
                    // TO DO: make more meaningful text
                    if (empty($data)) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    try {
                        ...
                        if ($con->affected_rows !== 1)
                            // TO DO: there is a primary key contraint on email, but it could be randomly generated equal

        ...
        <?php
            ...
            <form type="submit" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                <fieldset>
                    ...
                    <input type="text" id="firstname" name="firstname" placeholder="Your name.." value="<?php echo $_POST["fname"];?>"><br>

                    <label for="lastname">Cognome </label>
                    <input type="text" id="lastname" name="lastname" placeholder="Your surname.." value="<?php echo $_POST["lname"];?>"><br>

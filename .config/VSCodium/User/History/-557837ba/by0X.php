        ...
        <?php
            ...
            <form type="submit" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                <fieldset>
                    ...
                    <input type="text" id="lastname" name="lastname" placeholder="Your surname.." value="<?php echo $user_data["fname"];?>"><br>
        
                    <label for="email">Email </label>
                    <input type="email" id="email" name="email" placeholder="Your email.." value="<?php echo $user_data["fname"];?>"><br>
        
                    <label for="pass">Password </label>
                    <input type="password" id="pass" name="pass" placeholder="Password" value="<?php echo $user_data["fname"];?>"><br>
        
                    <label for="confirm">Conferma Password </label>
                    <input type="password" id="confirm" name="confirm"  placeholder="Confirm password" value="<?php echo $user_data["fname"];?>"><br>

    ...
    child: Widget.Box({
        ...
        children: [ 
            Widget.Revealer({
                transitionDuration: 600,
                transition: 'slide_left',
                revealChild: isAudioBarShown.bind(),
                child: Widget.Slider({
    ...
    child: Widget.Box({
        ...
        children: [ 
            Widget.Revealer({
                transitionDuration: 600,
                transition: 'slide_left',
                revealChild: isBatteryBarShown.bind(),
...
const WifiIndicator = () => Widget.Icon({
    className: 'bar-net',
}).bind('icon', Network.wifi, 'icon-name');

const WiredIndicator = () => Widget.Icon({
    className: 'bar-net',
}).bind('icon', Network.wired, 'icon-name');
    ...
    child: Widget.Box({
        ...
        children: [ 
            Widget.Revealer({
                ...
                child: Widget.Label().bind('label', Network.wifi, 'ssid')
            }),
            NetworkIndicator(),
        ]
    })
...
const SysTray = () => Widget.Box({
    ...
    connections: [[SystemTray, self => {
        self.children = SystemTray.items.map(item => Widget.EventBox({
            ...
            child: Widget.Icon({className: "tst-sys-icn",}).bind('icon', item, 'icon')),

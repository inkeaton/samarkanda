    ...
    wayland.windowManager.hyprland = {
        ...
        settings = {
            ...
            bind = [ 
                ...
                # Screenshots
                "Print,                     exec, ~/.config/nixos/scripts/screenshot sc"
                "SUPER, Print,              exec, ~/.config/nixos/scripts/screenshot sf"
                "CTRL, Print,               exec, ~/.config/nixos/scripts/screenshot si"
                "SHIFT, Print,              exec, ~/.config/nixos/scripts/screenshot rc"
                "SUPER SHIFT, Print,        exec, ~/.config/nixos/scripts/screenshot rf"
                "CTRL SHIFT, Print,         exec, ~/.config/nixos/scripts/screenshot ri"

                # Color picker
                "SUPER, C,                  exec, ~/.config/nixos/scripts/screenshot p"

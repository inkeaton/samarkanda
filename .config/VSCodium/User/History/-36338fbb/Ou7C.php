            ...
            <form type="submit" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                <fieldset>
                    ...
                    <input type="text" id="username" name="username" placeholder="Your username.." 
                           value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo htmlspecialchars($_POST["username"]); elseif (isset($row['username'])) echo htmlspecialchars($row['username']);?>"><br>

                    <label for="firstname">Name </label>
                    <input type="text" id="firstname" name="firstname" placeholder="Your name.." 
                           value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo htmlspecialchars($_POST["firstname"]); elseif (isset($row['nome'])) echo htmlspecialchars($row['nome']);?>"><br>

                    <label for="lastname">Surname </label>
                    <input type="text" id="lastname" name="lastname" placeholder="Your surname.." 
                           value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo htmlspecialchars($_POST["lastname"]); elseif (isset($row['cognome'])) echo htmlspecialchars($row['cognome']);?>"><br>

                    <label for="pronouns">Pronouns </label>
                    <input type="text" id="pronouns" name="pronouns" placeholder="Your pronouns.." 
                           value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo htmlspecialchars($_POST["pronouns"]); elseif (isset($row['pronome'])) echo htmlspecialchars($row['pronome']);?>"><br>

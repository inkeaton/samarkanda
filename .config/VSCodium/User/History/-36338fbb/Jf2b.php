                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["firstname"])) {
                    try {
                        ...
                        */
                        ...
                        // insert data
                        if(!$stmt = $con->prepare("INSERT INTO Utente (username, nome, cognome, pronome) VALUES (?, ?, ?, ?)"))
                            throw new Exception("<h1 class=\"error\">Unexpected Error, could not prepare query</h1>");
                        if(!$stmt->bind_param('ssss',$_POST["username"], $_POST["firstname"], $_POST["lastname"], $_POST["pronome"]))
